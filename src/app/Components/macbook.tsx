...
export default function Macbook() {
  return (
    <motion.div whileHover="animate" initial="initial" className="max-w-2xl w-full mx-auto flex items-center  h-96 bg-neutral-50">
...
className="w-60  mx-auto  perspective-distant">
  {/* lid */}
    ...
    <div className="w-full h-full   rounded-tl-[4px] rounded-tr-[4px] bg-neutral-900 overflow-hidden ">
      ...
      className="h-full w-full oject-cover" src='https://imgs.search.brave.com/MeDjYYbuOpQ76VN0_L7YXvNLV1si7S-SnchAkhkeFyE/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93ZWJh/c3NldHMubGluZWFy/LmFwcC9pbWFnZXMv/b3JuajczMHAvcHJv/ZHVjdGlvbi9iNzU1/MWFlNDRkMDM2NWMw/ZWQ4N2Q3ZTVlMjNh/ZWIwNDIxMjMzYmE1/LTIzNTJ4MTY1Ni5w/bmc_cT05NSZhdXRv/PWZvcm1hdCZkcHI9/Mg'>
